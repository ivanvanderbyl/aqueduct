...
var findPath = function (obj, search) {
    for (var key in obj) {
        ...
        if (obj[key] === search) {
            ...
            var deepPath = findPath(obj[key], search);
            if (deepPath) {
...
exports.getPath = function (search, params) {
    var path = findPath(exports.paths, search);
    if (!path) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Route__ = __webpack_require__(11);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var createHashHistory = __webpack_require__(41);
...
var MemoryRouter = __webpack_require__(15);
...
var StaticRouter = __webpack_require__(20);
...
var withRouter = __webpack_require__(22);
...
var home_1 = __webpack_require__(29);
var rest_1 = __webpack_require__(30);
var paths_1 = __webpack_require__(14);
var React = __webpack_require__(0);
var react_router_1 = __webpack_require__(32);
var nav_bar_1 = __webpack_require__(39);
    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(react_router_1.Switch, null,
                React.createElement(react_router_1.Route, { path: paths_1.getPath(paths_1.paths.home), component: home_1.Home }),
                React.createElement(react_router_1.Route, { path: paths_1.getPath(paths_1.paths.rest), component: rest_1.Rest }),
                React.createElement(react_router_1.Route, { path: paths_1.getPath(paths_1.paths.client), component: client_1.Client }),
                React.createElement(react_router_1.Redirect, { to: paths_1.getPath(paths_1.paths.home) }))));
    };
    return App;
}(React.Component));
exports.App = App;
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(12),p=__webpack_require__(13);__webpack_require__(8);var r=__webpack_require__(5);
...
var Rest = (function (_super) {
    ...
    Rest.prototype.render = function () {
        return (React.createElement("iframe", { src: './frames/redoc.html', className: 'iframe-frame' }));
    };
    return Rest;
}(React.Component));
exports.Rest = Rest;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MemoryRouter__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__StaticRouter__ = __webpack_require__(20);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "StaticRouter", function() { return __WEBPACK_IMPORTED_MODULE_5__StaticRouter__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Switch__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__withRouter__ = __webpack_require__(22);
...
var NavBar = (function (_super) {
    ...
    NavBar.prototype.render = function () {
        return (React.createElement("div", { className: 'navbar fl sb' },
            React.createElement("div", { className: 'fl' },
                React.createElement("a", { href: '#', className: 'logo-container' },
                    React.createElement("img", { src: './images/h-logo.svg' }))),
            React.createElement("div", { className: 'fl' },
                React.createElement(react_router_dom_1.NavLink, { activeClassName: 'is-active', to: paths_1.getPath(paths_1.paths.rest), className: 'link' }, "REST API"),
                React.createElement(react_router_dom_1.NavLink, { activeClassName: 'is-active', to: paths_1.getPath(paths_1.paths.client), className: 'link' }, "JavaScript Client"))));
    };
    return NavBar;
}(React.Component));
...
*/
var aa=__webpack_require__(0);__webpack_require__(8);var l=__webpack_require__(44),n=__webpack_require__(12),ba=__webpack_require__(45),ca=__webpack_require__(5),da=__webpack_require__(13),ea=__webpack_require__(46),fa=__webpack_require__(47),ha=__webpack_require__(50),ia=__webpack_require__(51);
